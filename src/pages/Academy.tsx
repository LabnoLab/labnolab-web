...
export default function Academy() {
  ...
  const target = useMemo(() => new Date("2026-03-10T19:00:00"), []);
    ...
    <div id="top">
      ...
      <section className="py-10 grid place-items-center text-center">
        <div className="pad-x-fluid">
          ...
          <p className="mt-6 text-lg font-extrabold uppercase tracking-wider">VOL.3 — DEL 10/03 AL 14/04 · MARTES 19:00-20:30H (ESP)</p>
